            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly value="{!! $kabupaten->nama !!}">
                    </div>
...
@section('js')
    ...
    <script>
        ...
        function del(id) {
            $.ajax({
                url: '{{ url('kecamatan/delete?id') }}=' + id,
                type: 'get',
                success: function (d) {
                    if (d == 'success') {
                        Swal.fire({
        ...
        $(document).on('click','.btn-kel', function () {
            var id = $(this).data('id')
            window.location = "{!! url('kelurahan?kecamatan_id') !!}="+id
        })
        ...
        function getAll() {
            $.ajax({
                type: 'get',
                url: "{!! url('kecamatan/get-all?kabupaten_id=') !!}"+kabupaten_id,
                success: function (r) {
                    console.log(r)
                    var data = []
                    var no = 1;
                    $.each(r.kecamatan, function (i, d) {
                        var btn_kelurahan = '<button class="btn btn-primary btn-xs btn-kel" data-id="'+d.id+'">'+d.kelurahan.length+' Kelurahan</button>'
